...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UAOL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UAOL_INIT_PRIORITY, 40);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UAOL_INTEL_ADSP_CLOCK_FREQUENCY, 19200000);
